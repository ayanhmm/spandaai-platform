...
from services.model_configs import CancellationToken
...
async def send_multimodal_chat_message(
    ...
    try:
        # Create a custom timeout object with all timeouts disabled
        timeout = aiohttp.ClientTimeout(
            total=None,  # Total timeout (including connection, reading, etc.)
            connect=None,  # Connection timeout
            sock_connect=None,  # Socket connection timeout
            sock_read=None  # Socket reading timeout
        )
