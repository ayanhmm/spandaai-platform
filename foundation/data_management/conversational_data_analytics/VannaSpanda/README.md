# Vanna AI with PostgreSQL Integration

A specialized implementation of Vanna AI that connects to PostgreSQL databases and allows natural language querying of your data.

## Features

- Load CSV files automatically into PostgreSQL tables
- Generate database schema, documentation, and example queries
- Train Vanna AI on your specific data structures
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/spandaai/VannaSpanda.git
   cd VannaSpanda
   ```
...
4. **Configure the application:**
   ...
   - Edit `config.py` to update:
     - PostgreSQL credentials (DB_USER, DB_PASS)
...
5. **Prepare your data:**
   ...
   - Sample CSV files are included (demands.csv, processing.csv, transportation.csv)
...
2. **The script will:**
   ...
   - Generate schema information, documentation, and example queries
   - Train the Vanna model with your data
   - Start an interactive mode where you can ask questions about your data

3. **Example queries:**
   - "How many records are in the transportation table?"
   - "What is the average value in the demands table?"
   - "Show me a sample of data from processing"

4. **Optional features:**
   - When prompted, you can choose to include complex query examples if you have the `complex_training.py` file

5. **Exit the application:**
   - Type 'exit' when prompted for a question

## Custom Vanna Implementation

This implementation extends the base Vanna classes to:
- Support both SELECT and UPDATE queries
- Handle PostgreSQL connection with empty passwords
- Generate comprehensive documentation based on your data
