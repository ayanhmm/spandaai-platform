...
import logging
import uvicorn
from spanda_domains.services.EdTech.microservices.data_preprocessing.spanda_types import *
from spanda_domains.services.EdTech.microservices.data_preprocessing.data_processing import (
    chunk_text,
    get_first_n_words,
    resize_image,
    process_pdf,
